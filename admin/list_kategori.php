                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-bordered" >
                      ...
                      <tr>
                          ...
                          <td>
                            <a href="#" class="btn btn-xs btn-warning open_modal" id="<?php echo $tmp['id_kategori']; ?>" ><i class="glyphicon glyphicon-pencil"></i> edit</a>
                            <a href="#" class="btn btn-xs btn-danger" onclick="confirmdel('proses/hapus_kategori.php?&id_kategori=<?php echo $tmp['id_kategori']; ?>');"><i class="glyphicon glyphicon-trash"></i> hapus</a>
                          </td>
                      </tr>
                      <?php } ?>
                    </table>
