...
<div class="modal-dialog" style="margin-top: 150px">
    <div class="modal-content">
        <div class="modal-body">
          	<form role="form" action="proses_setuju_brg.php" enctype="multipart/form-data" method="POST">
                <div class="form-group" style="padding-bottom: 20px;">
                  	<h1 class="modal-title" id="myModalLabel">Apa Anda yakin Untuk Menyetujui men.!</h1>
